...
import pandas as pd  # Import pandas for easier post-processing
...
keywords_to_skip = [
    ...
    "ENERGY", "MARKETING", "PLANT", "PROCESSING","GARMENTS","GARMENT","GARM","TECH"
]
...
def process_input_file(input_file, output_file, base_dir='Output_Scraper'):
            ...
            if any(keyword in name for keyword in keywords_to_skip):
                ...
                for part in name_parts:
                    ...
                    if urdu_name:
                        ...
                        break  # Exit the loop if any part fails to translate

                # Set NAME IN URDU, Sahib/Sahiba, and Gender to "N/A" if not all parts are translated
                if all_parts_translated:
                    row['NAME IN URDU'] = " ".join(urdu_names)
    ...
    # Post-process the output file to ensure consistency
    df = pd.read_csv(output_file, encoding='utf-8')
    df.loc[df['NAME IN URDU'] == "N/A", ['Sahib/Sahiba', 'Gender']] = "N/A"
